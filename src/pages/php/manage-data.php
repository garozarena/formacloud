<?php
   ...
   switch($key)
   {
      ...
      case "create":
         ...
         try {
            $sql 	= "INSERT INTO usuarios( usuario, password, IDcomercial) VALUES(:usuario, :password, :IDcomercial)";
            $stmt 	= $pdo->prepare($sql);
            $stmt->bindParam(':usuario', $usuario, PDO::PARAM_STR);
            $stmt->bindParam(':password', $password, PDO::PARAM_STR);
            $stmt->bindParam(':IDcomercial', $IDcomercial, PDO::PARAM_STR);
            $stmt->execute();

            echo json_encode(array('message' => 'Congratulations the record ' . $usuario . ' was added to the database'));
         }
